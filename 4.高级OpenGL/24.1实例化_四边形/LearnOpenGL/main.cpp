...
int main()
{
    ...
    glad_glGenBuffers(1, &instanceVBO);
    glad_glBindBuffer(GL_ARRAY_BUFFER,instanceVBO);
    glad_glBufferData(GL_ARRAY_BUFFER,sizeof(glm::vec2)*100, &translations[0], GL_STATIC_DRAW);
    ...
    glad_glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (void*)0);
    glad_glEnableVertexAttribArray(1);
    glad_glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (void*)(2 * sizeof(float)));
    
    glad_glBindBuffer(GL_ARRAY_BUFFER,instanceVBO);
    glad_glEnableVertexAttribArray(2);
    glad_glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 2 * sizeof(float), (void*)0);
    glad_glBindBuffer(GL_ARRAY_BUFFER,0);
...
//    渲染循环
    ...
    glad_glDeleteBuffers(1, &instanceVBO);
